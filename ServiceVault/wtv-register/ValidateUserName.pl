...
print "500 User name aleady in registry.\n\n";
}else{
...
<INPUT TYPE="hidden" NAME="subscriber-name-last" VALUE="$decidedusernameL">
...
First: <img src="ROMCache/Spacer.gif" width=7 height=1><br>
<td width=3 valign=top align=left>
<td width=174 valign=top align=left>

<INPUT noSubmit NAME="subscriber-name-first" ID="subscriber-name-first" Value="$decidedusernameF"
