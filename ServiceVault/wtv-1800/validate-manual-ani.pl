...
<td width=20 valign=top align=left>
<form action="get-ani" enctype="x-www-form-encoded" method="POST">
<tr>
...
<font size=+1>
The number <b>$fvc</b> is a unknown number to our damn system.  This is not how WNI checks the number but OH WEll :) (:...
<tr>
