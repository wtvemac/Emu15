...
$FolderName="";
$FavCURL="LeftTop.gif";
$BrocHTML="<td width=20 height=28 align=left valign=top>";
...
if($namem eq "favorite-folder-name"){
$FolderName=$valuem;
}
...
<table cellspacing=0 cellpadding=0>
<tr><td height=18>
<table width=20 height=20 cellspacing=0 cellpadding=0 href="wtv-favorite:/serve-browser?favorite-folder-name=$FavData[$Concur]&backward=selected"><tr>
<td>&nbsp
</table>
<tr><td height=5>
</table>
...
$FavThumb="wtv-favorite:/Thumbnails/$FavThumb.bmp?folder=$FolderName";
}
$HTMLcont.="<table href=\"$FavURL\" >
<tr><td abswidth=139 align=center>
<img vspace=5 src=\"$FavThumb\" width=70 height=52><br>
<table cellspacing=0 cellpadding=0>
...
if($ThisfolderCountX == "1"){

$mitahl=<<"ERIC"

<table width=100% cellspacing=0 cellpadding=0 href="wtv-favorite:/serve-add-folder-page?favorite-folder-name=$FolderName">
<tr><td>
<table cellspacing=0 cellpadding=0>
...
<td width=5>
<tr><td colspan=3 width=103 absheight=2 bgcolor=#6C676B>
...
$mitahl=<<"ERIC"
<table abswidth=93 cellspacing=0 cellpadding=0 href="wtv-favorite:/serve-folders?favorite-folder-name=$FolderName">
<tr><td>
<table cellspacing=0 cellpadding=0>
<tr><td><shadow><font color=E7CE4A>
&nbsp;Folders
...
<td width=20 height=28 align=left valign=middle>
...
print $clients "500 Unknown folder name: \"$FolderName\"?  Fooling with URLs?\n\n";
